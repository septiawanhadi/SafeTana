...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-[#020617] text-slate-900 dark:text-slate-200 font-sans transition-colors duration-300">
      {/* SPLASH SCREEN ΓÇô muncul sekali saat pertama kali buka aplikasi */}
      {showSplash && <SplashScreen onDone={handleSplashDone} />}
      {/* ONBOARDING ΓÇô render sejak awal (di bawah splash z-99999), agar saat splash fade-out tidak ada gap */}
